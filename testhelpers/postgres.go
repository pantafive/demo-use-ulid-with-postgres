...
func NewTestDatabase(t *testing.T) *TestDatabase {
	...
	request := testcontainers.GenericContainerRequest{ContainerRequest: req, Started: true}
	postgres, err := testcontainers.GenericContainer(ctx, request)
	require.NoError(t, err)
	return &TestDatabase{instance: postgres}
}
